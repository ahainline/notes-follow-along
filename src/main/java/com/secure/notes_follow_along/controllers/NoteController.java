package com.secure.notes_follow_along.controllers;

import com.secure.notes_follow_along.models.Note;
import com.secure.notes_follow_along.services.NoteService;
...
public class NoteController {
    ...
    @PutMapping("/{noteId}")
    public Note udeateNote (@PathVariable Long noteId, @RequestBody String content,
